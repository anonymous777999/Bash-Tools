...
PENALTY_DOCKER_EXPOSED="${PENALTY_DOCKER_EXPOSED:-15}"
PENALTY_K8S_EXPOSED="${PENALTY_K8S_EXPOSED:-20}"
PENALTY_ROOT_SERVICES="${PENALTY_ROOT_SERVICES:-5}"
PENALTY_EXPIRED_CERTS="${PENALTY_EXPIRED_CERTS:-8}"
PENALTY_WEAK_TLS="${PENALTY_WEAK_TLS:-5}"
PENALTY_UNKNOWN_PORTS="${PENALTY_UNKNOWN_PORTS:-3}"
PENALTY_CRITICAL_PORT="${PENALTY_CRITICAL_PORT:-10}"
BONUS_FIREWALL="${BONUS_FIREWALL:--10}"
BONUS_SELINUX="${BONUS_SELINUX:--8}"
BONUS_NO_CRITICAL="${BONUS_NO_CRITICAL:--15}"
BONUS_NO_HIGH="${BONUS_NO_HIGH:--8}"
BONUS_APARMOR="${BONUS_APARMOR:--5}"
