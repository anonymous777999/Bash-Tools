...
declare -g PROCESS_CHANGED_WEIGHT="${PROCESS_CHANGED_WEIGHT:-35}"
declare -g USER_CHANGED_WEIGHT="${USER_CHANGED_WEIGHT:-25}"
declare -g NEW_PORT_WEIGHT="${NEW_PORT_WEIGHT:-30}"
declare -g PORT_GONE_WEIGHT="${PORT_GONE_WEIGHT:-15}"
declare -g BIND_CHANGED_WEIGHT="${BIND_CHANGED_WEIGHT:-20}"
declare -g RISK_JUMP_WEIGHT="${RISK_JUMP_WEIGHT:-10}"
declare -g PROCESS_COUNT_CHANGED_WEIGHT="${PROCESS_COUNT_CHANGED_WEIGHT:-5}"

# Thresholds
declare -g ANOMALY_ALERT_THRESHOLD="${ANOMALY_ALERT_THRESHOLD:-50}"
declare -g ANOMALY_WARN_THRESHOLD="${ANOMALY_WARN_THRESHOLD:-30}"

# Profile paths
declare -g ANOMALY_PROFILE_DIR="$HOME/.config/port-watcher"
declare -g ANOMALY_PROFILE_FILE="${ANOMALY_PROFILE_DIR}/anomaly-profile.json"
